...
export const timelineCards = [
  ...
  },
  {
    ...
    modalDescription: "Week 10 draait om de wedstrijd. We hebben de afgelopen periode veel tijd en energie gestoken in het ontwikkelen van ons product. Al dat harde werk heeft geleid tot een mooi eindresultaat waar we trots op zijn. Nu is het tijd om alles samen te brengen en ons product in actie te zien tijdens het live evenement in De Kuip. Een mooie afsluiting van een leerzaam project.",
